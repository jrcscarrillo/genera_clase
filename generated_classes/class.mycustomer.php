...
$_SESSION['mycustomer']['CustomField1'] = htmlspecialchars(strip_tags($_SESSION['mycustomer']['CustomField1']));
$_SESSION['mycustomer']['CustomField2'] = htmlspecialchars(strip_tags($_SESSION['mycustomer']['CustomField2']));
$_SESSION['mycustomer']['CustomField3'] = htmlspecialchars(strip_tags($_SESSION['mycustomer']['CustomField3']));
$_SESSION['mycustomer']['CustomField4'] = htmlspecialchars(strip_tags($_SESSION['mycustomer']['CustomField4']));
$_SESSION['mycustomer']['CustomField5'] = htmlspecialchars(strip_tags($_SESSION['mycustomer']['CustomField5']));
$_SESSION['mycustomer']['CustomField6'] = htmlspecialchars(strip_tags($_SESSION['mycustomer']['CustomField6']));
$_SESSION['mycustomer']['CustomField7'] = htmlspecialchars(strip_tags($_SESSION['mycustomer']['CustomField7']));
$_SESSION['mycustomer']['CustomField8'] = htmlspecialchars(strip_tags($_SESSION['mycustomer']['CustomField8']));
$_SESSION['mycustomer']['CustomField9'] = htmlspecialchars(strip_tags($_SESSION['mycustomer']['CustomField9']));
$_SESSION['mycustomer']['CustomField10'] = htmlspecialchars(strip_tags($_SESSION['mycustomer']['CustomField10']));
$_SESSION['mycustomer']['CustomField11'] = htmlspecialchars(strip_tags($_SESSION['mycustomer']['CustomField11']));
$_SESSION['mycustomer']['CustomField12'] = htmlspecialchars(strip_tags($_SESSION['mycustomer']['CustomField12']));
$_SESSION['mycustomer']['CustomField13'] = htmlspecialchars(strip_tags($_SESSION['mycustomer']['CustomField13']));
$_SESSION['mycustomer']['CustomField14'] = htmlspecialchars(strip_tags($_SESSION['mycustomer']['CustomField14']));
$_SESSION['mycustomer']['CustomField15'] = htmlspecialchars(strip_tags($_SESSION['mycustomer']['CustomField15']));
$_SESSION['mycustomer']['Status'] = htmlspecialchars(strip_tags($_SESSION['mycustomer']['Status']));
    }
    ...
    function buscaIgual_mycustomer() {
        ...
        try {
            ...
            if ( ! $registro){
                ...
                if ($registro['TxnID'] === $_SESSION['mycustomer']['TxnID']) {
